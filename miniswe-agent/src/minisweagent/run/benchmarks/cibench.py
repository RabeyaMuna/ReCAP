...
# Automated fix tools DISABLED - removed to prevent automated repair suggestions
# Agent should analyze and fix problems manually without tool recommendations
